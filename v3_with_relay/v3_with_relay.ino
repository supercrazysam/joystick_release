...
float joystick_max = 900.0;//v2 true joystick max become 950 ///// //600.0;//650.0; //650.0;
float joystick_min = 120.0;//v2 true joystick min become 110 ///// //48.0;
...
// ==================
float top_limit = 1375;    // increase the top_limit value to move the top limit down, decrease the value to move the top limit up.  
//  1665 is the bottom limit      1545 is the position of mid point, dont change
float bottom_limit = 1665;     // increase the bottom_limit value to move the bottom_limit down, decrease the value to move the bottom limit up.  
